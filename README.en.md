...
- **The version directory exists but the SDK files are stale**: check whether the version verification failed in the log; use `--dry-run` to see which version it intends to install.
